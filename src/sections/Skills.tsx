      ...
      <div className="max-w-7xl mx-auto">
        ...
        <motion.div
          ...
          <h2 className="text-4xl md:text-5xl font-bold mb-4">
            <span className="gradient-text-cyan">Habilidades Técnicas</span>
          </h2>
          ...
          {skills.map((skill, idx) => {
            ...
            return (
              <motion.div
                ...
                <div className="glass p-6 rounded-2xl border border-cyan-400/20 hover:border-cyan-400/50 transition-all duration-300 h-full flex flex-col items-center justify-center gap-4 relative overflow-hidden">
        ...
        <motion.div
          ...
          <div className="glass p-6 rounded-2xl border border-cyan-400/20 text-center">
            <div className="text-4xl font-bold gradient-text-cyan mb-2">12+</div>
            <p className="text-gray-400">Tecnologías Dominadas</p>
          </div>

          <div className="glass p-6 rounded-2xl border border-purple-400/20 text-center">
          ...
          <div className="glass p-6 rounded-2xl border border-blue-400/20 text-center">
