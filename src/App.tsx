...
export default function App() {
  ...
  return (
    <div className="animated-gradient text-gray-200 font-sans leading-relaxed relative min-h-screen">
      <CursorSpot />
      ...
      <motion.footer
        ...
        <div className="relative glass-strong border-t border-cyan-400/20">
          <div className="container mx-auto px-6 py-12">
            <div className="grid md:grid-cols-3 gap-8 mb-8">
              {/* Columna 1 */}
              <div>
                <h3 className="text-xl font-bold gradient-text-cyan mb-4">
                  Duban Alejandro
                </h3>
              ...
              <div>
                ...
                <div className="flex gap-4">
                  <a
                    ...
                    className="w-10 h-10 flex items-center justify-center rounded-lg glass border border-cyan-400/20 hover:border-cyan-400/50 hover:bg-cyan-400/10 transition-all">
                    <svg
